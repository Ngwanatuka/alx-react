      ...
      <AppContext.Provider value={{ user, logOut: logout }}>
        <div className={css(styles.app)}>
          ...
          <div className={css(styles.appHeader)}>
            <Header displayDrawer={this.handleDisplayDrawer} isLoggedIn={isLoggedIn} />
          </div>
...
const mapStateToProps = (state) => {
  return {
    isLoggedIn: state.ui && state.ui.isLoggedIn,
    isNotificationDrawerVisible: state.ui && state.ui.isNotificationDrawerVisible,
  };
};
