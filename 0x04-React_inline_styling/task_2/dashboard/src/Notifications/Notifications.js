        ...
        {displayDrawer ? (
          <div className={css(styles.fullScreen)}>
            ...
            <div className={css(styles.Notifications)}>
              ...
              <p className={css(styles.largeText)}>Here is the list of notifications</p>
...
const styles = StyleSheet.create({
  Notifications: {
    ...
    right: '15px',
    top: '50px',
    fontSize: '20px', // Requirement: text font size
  },
  buttonImage: {
    width: '10px',
  },
  ...
  // New styles to address the provided requirements
  fullScreen: {
    position: 'fixed',
    top: 0,
    left: 0,
  ...
  '@media screen and (max-width: 900px)': {
    Notifications: {
      width: '100%', // Take over the entire screen width
      right: 0,     // Adjust position to the right edge
      top: 0,       // Adjust position to the top edge
    },
  },
});
